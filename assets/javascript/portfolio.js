...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://youtube.com/@fagify" target="_BLANK"> « youtube »     </a>`);
    $('#marquee').append(`<a href="https://discord.gg/fagify" target="_BLANK"> « discord »     </a>`);
    $('#marquee').append(`<a href="https://tiktok.com/@fagify" target="_BLANK"> « tiktok »     </a>`);
    $('#marquee').append(`<a href="https://youtube.com/@fagify" target="_BLANK"> « youtube »     </a>`);
    $('#marquee').append(`<a href="https://discord.gg/fagify" target="_BLANK"> « discord »     </a>`);
    $('#marquee').append(`<a href="https://tiktok.com/@fagify" target="_BLANK"> « tiktok »     </a>`);
    $('#marquee').append(`<a href="https://youtube.com/@fagify" target="_BLANK"> « youtube »     </a>`);
  ...
  app.titleChanger(['batman', 'batman on top', 'professional skid', 'best shittalker']);
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #06d;'>[batmans sex page]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from <i style='color: #0f0'>${country}</i> here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #F62459'>batman loves to skid! $$$</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
